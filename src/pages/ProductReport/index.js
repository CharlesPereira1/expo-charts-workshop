...
function ProductReport() {
  const [productReportDimensins, setProductReportDimensins] = useState(null);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.reportContainer}>
        ...
        <View
          ...
          }) => setProductReportDimensins({ width, height })}
          style={[
            styles.reportChart,
            productReportDimensins
        ...
        >
          <CustomLineChart
            ...
            chartDimensions={productReportDimensins}
          />
        </View>
